                    ...
                    <form action="{{ route('apply-loan') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="row justify-content-center" id="cardSection">
                            <div class="col-lg-9 col-md-9" id="stepOneMedia">
                                ...
                                <button type="button" class="mt-4 btn btn-prime -btnfloat-end next">Continue</button>
                            </div>
                        </div>
                                        ...
                                        <div class="">
                                            <div class="col-12 col-md-12">
                                                <div class="card-body">
                                                    <div class="row justify-content-center">
                                                        <div class="col-12">
                                                            <h4 class="mt-2 mb-1 text-center text-secondary" style="position: relative;">Duration</h4>
                                                        </div>
                                                        <div class="col-12">
