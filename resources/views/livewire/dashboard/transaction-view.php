                ...
                <div class="">
                    <div style="background-color:#792db8;" class="card-header">
                        <h4 class="card-title" style=" color:#f0f0f0">
                            <svg width="35" height="35" viewBox="0 0 512.00 512.00" xmlns="http://www.w3.org/2000/svg"
                                fill="#c892d3" stroke="#c892d3" stroke-width="8.192">
                        ...
                        <ul>
                            <li style="border-bottom:1px solid #f0f0f0;">
                                <a href="{{ route('transaction.item', ['view'=>'payments']) }}"
                                    style="border-bottom:1px solid #f0f0f0; display:flex; gap:12px; padding:1%;padding-top:2%;">
                                    <span>
                            ...
                            <li style="border-bottom:1px solid #f0f0f0;">
                                <a href="{{ route('transaction.item', ['view'=>'deposits']) }}"
                                    style="border-bottom:1px solid #f0f0f0; display:flex; gap:12px; padding:1%;padding-top:2%;">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                            ...
                            <li>
                                <a href="{{ route('transaction.item', ['view'=>'withdrawals']) }}"
                                    style="border-bottom:1px solid #f0f0f0; display:flex; gap:12px; padding:1%;padding-top:2%;">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                            ...
                            <li style="border-bottom:1px solid #f0f0f0;">
                                <a href="{{ route('transaction.item', ['view'=>'transfers']) }}"
                                    style="border-bottom:1px solid #f0f0f0; display:flex; gap:12px; padding:1%;padding-top:2%;">
                            ...
                            <li style="border-bottom:1px solid #f0f0f0;">
                                <a href="{{ route('transaction.item', ['view'=>'investments']) }}"
                                    style="border-bottom:1px solid #f0f0f0; display:flex; gap:12px; padding:1%;padding-top:2%;">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
