...
<div class="mb-5 col-12">
    ...
    <div class="flex-wrap gap-3 quick-actions d-flex justify-content-between w-100">
        <a href="{{ route('profile.show', ['view' => 'kyc']) }}" style="background-color: #6a3093 ; border-radius:1rem" class="p-3 text-center text-white action-item d-flex flex-column align-items-center flex-fill text-decoration-none" >
        ...
        @if ($my_loan == null)
        <a href="{{ route('new-loan') }}" style="background-color: #6a3093; border-radius:1rem" class="p-3 text-center text-white action-item d-flex flex-column align-items-center flex-fill text-decoration-none">
            <div class="mb-2 d-flex align-items-center justify-content-center" style="width:60px; height:60px;">
        ...
        <a style="background-color: #6a3093; border-radius:1rem" class="p-3 text-center text-white action-item d-flex flex-column align-items-center flex-fill text-decoration-none " href="#">
            <div class="mb-2 d-flex align-items-center justify-content-center" style="width:60px; height:60px;">
        ...
        <a href="{{ route('profile.show', ['view'=>'profile']) }}" style="background-color: #6a3093; border-radius:1rem" class="p-3 text-center text-white action-item d-flex flex-column align-items-center flex-fill text-decoration-none " href="#">
            <div class="mb-2 d-flex align-items-center justify-content-center" style="width:60px; height:60px;">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-credit-card" viewBox="0 0 16 16">
                    <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v1h14V4a1 1 0 0 0-1-1zm13 4H1v5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1z"/>
                    <path d="M2 10a1 1 0 0 1 1-1h1a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1zm5 0a1 1 0 0 1 1-1h1a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H8a1 1 0 0 1-1-1z"/>
