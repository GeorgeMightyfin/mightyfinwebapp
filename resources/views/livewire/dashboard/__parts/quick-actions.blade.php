...
<div class="mb-5 col-12">
    ...
    <div class="flex-wrap gap-3 quick-actions d-flex justify-content-between w-100">
        <a style="background-color: rgba(106, 48, 147, 0.85); border-radius:1rem" class="p-3 text-center text-white action-item d-flex flex-column align-items-center flex-fill text-decoration-none " href="{{ route('profile.show', ['view' => 'kyc']) }}">
