...
<div class="mb-5 col-12">
    ...
    <div class="flex-wrap gap-3 quick-actions d-flex justify-content-between w-100">
        <a style="background-color: #683cb9; border-radius:1rem" class="p-3 text-center text-white action-item d-flex flex-column align-items-center flex-fill text-decoration-none " href="{{ route('profile.show', ['view' => 'kyc']) }}">
        ...
        <a style="background-color: #683cb9; border-radius:1rem" class="p-3 text-center text-white action-item d-flex flex-column align-items-center flex-fill text-decoration-none " href="#">
            <div class="mb-2 d-flex align-items-center justify-content-center" style="width:60px; height:60px;">
