                        ...
                        <script>
                            function previewFile() {
                                ...
                                if (file) {
                                    ...
                                    previewImage.src = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQmw0mqGxMV3LaBmRd2LTjBWq8PMMm2ZnoiopUzXmaMlw&s";
                                }
                            }
                        </script>
            ...
            <div class="">
                ...
                <div class="">
                    ...
                    <form action="{{ route('update-profile') }}" method="POST" class="row g-4">
                        ...
                        <div class="col-12">
                            <button type="submit" class="btn btn-success pl-5 pr-5 waves-effect"
                            >
                            Save Changes
                            </button>
                        </div>
